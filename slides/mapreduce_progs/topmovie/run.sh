#/bin/bash
MP=/Users/mparsian
WORDCOUNT=$MP/zmp/BigData-MapReduce-Course/programs/topmovie
...
APP_JAR=$WORDCOUNT/topmovie.jar
...
# run the program 
$HADOOP_HOME/bin/hadoop jar  $APP_JAR TopMovieDriver $INPUT $OUTPUT
