...
/**
 * LogHandlerDriver: submits the job to Hadoop
 *
 * @author Mahmoud Parsian
 *
 */
public class LogHandlerDriver  extends Configured implements Tool {

	private static Logger theLogger = Logger.getLogger(LogHandlerDriver.class);

	public int run(String[] args) throws Exception {
    		
		Job job = new Job(getConf());
		job.setJarByClass(LogHandlerDriver.class);
		...
		job.setCombinerClass(LogHandlerReducer.class);
	...
	*/
	public static int submitJob(String[] args) throws Exception {
		...
		int returnStatus = ToolRunner.run(new LogHandlerDriver(), args);
		return returnStatus;
	}
}
