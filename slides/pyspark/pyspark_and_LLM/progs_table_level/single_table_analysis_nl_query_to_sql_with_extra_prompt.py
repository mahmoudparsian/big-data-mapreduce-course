...
This version adds a new instruction to the prompt:
remove "```sql" from the beginning and "```" from the end of generated sql.
...
### 🧠 Python Script (`spark_nl_to_sql.py`)
...
Now, translate the following question into a Spark SQL query (
do not explain it, just give the SQL, and
remove "```sql" from the beginning and "```" from the end of generated sql
):
